...
import com.kyk.soundstory.mappers.UserMapper;
import com.kyk.soundstory.misc.MailSender;
import com.kyk.soundstory.regexes.EmailAuthRegex;
import com.kyk.soundstory.regexes.UserRegex;
import com.kyk.soundstory.results.CommonResult;
import com.kyk.soundstory.results.Result;
import com.kyk.soundstory.results.user.LoginResult;
import com.kyk.soundstory.results.user.RegisterResult;
import com.kyk.soundstory.results.user.SendRegisterEmailResult;
import com.kyk.soundstory.results.user.VerifyRegisterEmailResult;
...
public class UserService {
    ...
    @Autowired
    public UserService(UserMapper userMapper, JavaMailSender mailSender, SpringTemplateEngine templateEngine, PlaylistMapper playlistMapper) {
